    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        ValueEventListener eventListener = new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                spiSelectCompany.setAdapter(new MySpinnerAdapter(EditManagerActivity.this,R.layout.textview_spinner,companyName));
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        for (DataSnapshot ds : dataSnapshot.getChildren()) {
                            ...
                            if(uid.equals(userId))
                            {
                                ...
                                int index = companyUid.indexOf(companyUID);
                                Toast.makeText(EditManagerActivity.this, ""+index, Toast.LENGTH_SHORT).show();
                                spiSelectCompany.setSelection(index);
                                selectedCompanyUid = companyUID;
                                selectedUserType = companyName.get(index);
                            }
                        }
        ...
        btnSignUp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                updateData.child("companyname").setValue(selectedUserType);
                updateData.child("companyUid").setValue(selectedCompanyUid);
                Toast.makeText(EditManagerActivity.this, "Data has been updated", Toast.LENGTH_SHORT).show();
                finish();
            }
        });
