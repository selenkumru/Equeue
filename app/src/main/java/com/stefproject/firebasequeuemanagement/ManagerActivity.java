...
public class ManagerActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        imgAddManager.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(ManagerActivity.this,AddManagerActivity.class);
        ...
        ValueEventListener eventListener = new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                ArrayAdapter<String> adapter = new ArrayAdapter(ManagerActivity.this, android.R.layout.simple_list_item_1, array);
    ...
    public boolean onContextItemSelected(MenuItem item) {
        ...
        switch(item.getItemId()) {
            case R.id.edit:
                // edit stuff here
                Intent intent = new Intent(ManagerActivity.this,EditManagerActivity.class);
            ...
            case R.id.delete:
                ...
                Toast.makeText(ManagerActivity.this, "I am here"+info.position, Toast.LENGTH_SHORT).show();
                return true;
            default:
